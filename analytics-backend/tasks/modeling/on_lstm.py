...
# https://github.com/victorling8/pytext/blob/7916ac54d362e50a608c469a3c7b3cfb517cdae1/pytext/models/representations/ordered_neuron_lstm.py
...
class OrderedNeuronLSTMLayer(nn.Module):
    def __init__(
